...
const SpeedMeter = ({ speed }: { speed: number }) => {
  ...
  return (
    <svg viewBox="15 20 190 105" width="160" height="88">
      ...
      <text x={cx} y={cy - 20} textAnchor="middle" fontSize="24" fontWeight="bold" fill="#333">{speed.toFixed(1)}</text>
      <text x={cx} y={cy - 6} textAnchor="middle" fontSize="11" fill="#999">km/h</text>
    </svg>
  )
}
