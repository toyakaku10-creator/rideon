...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-[var(--bg)]" style={{ height: '100dvh' }}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">
              <g transform={`rotate(${(isDemoMode ? demoHeading : heading) ?? 0} 32 32)`}>
                {(isDemoMode ? demoHeading : heading) != null && (
                  <>
                    <polygon points="32,4 40,18 24,18" fill="#4A90D9" stroke="white" strokeWidth="1.5" strokeLinejoin="round"/>
                    <rect x="24" y="16" width="16" height="3" fill="white"/>
                  </>
                )}
          ...
          >
            {isDemoMode ? (
              <svg width="130" height="38" viewBox="0 0 130 38">
                ...
                <text x="75" y="24" textAnchor="middle" fontSize="18" fontWeight="700" fill="white" fontFamily="'Bebas Neue', cursive">Demo</text>
              </svg>
            ) : tab === 'speed' ? (
              <svg width="130" height="38" viewBox="0 0 130 38">
                <rect x="19" y="2" width="109" height="34" fill="#D4AF37" stroke="#D4AF37" strokeWidth="2" rx="4"/>
                <circle cx="19" cy="19" r="17" fill="white" stroke="#D4AF37" strokeWidth="2"/>
                <rect x="10" y="10" width="18" height="18" fill="#D4AF37" rx="2"/>
                <text x="75" y="24" textAnchor="middle" fontSize="18" fontWeight="700" fill="white" fontFamily="'Bebas Neue', cursive">RideOn</text>
              </svg>
            ) : (
              <svg width="130" height="38" viewBox="0 0 130 38">
                ...
                <text x="75" y="24" textAnchor="middle" fontSize="18" fontWeight="700" fill="#D4AF37" fontFamily="'Bebas Neue', cursive">RideOn</text>
              </svg>
            )}
          </div>
        </div>
      ...
      {/* スタート補正バナー（地図とフッターの間） */}
      {isAdjustingImport && !isShareImport && (
