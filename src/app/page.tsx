...
export default function Home() {
  ...
  const [mapStyle, setMapStyle] = useState<'default' | 'soft' | 'gray' | 'retro' | 'silver' | 'dark'>(() =>
    (typeof window !== 'undefined' ? localStorage.getItem('rideon-map-style') : null) as 'default' | 'soft' | 'gray' | 'retro' | 'silver' | 'dark' | null ?? 'default'
  );
  ...
  const handleMapStyleChange = (style: string) => {
    setMapStyle(style as 'default' | 'soft' | 'gray' | 'retro' | 'silver' | 'dark');
